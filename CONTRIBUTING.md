...
## Contributing to Qiskit Random Number Generation
...
https://github.com/qiskit-community/qiskit_rng/pulls
...
When you contribute to this project with a new pull request,
...
will make it easier for your code to be reviewed and provide context to the
...
### Installing qiskit_rng from source

To install `qiskit_rng` from a local git checkout you should 
run:
...
which will install the local checkout in the editable mode.
...
The development cycle for qiskit_rng is all handled in the open using
...
[issue tracker]: https://github.com/qiskit-community/qiskit_rng/issues
